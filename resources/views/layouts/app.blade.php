							...
							<ul>
								<li>
									...
									<ul class="language-dropdown">
										<li><a href="#"><img src="{{asset('img/theme/flag-fr.png')}}" alt="">Français</a></li>
										<li><a href="#"><img src="{{asset('img/theme/flag-dt.png')}}" alt="">Deutsch</a></li>
										<li><a href="#"><img src="{{asset('img/theme/flag-ru.png')}}" alt="">Pусский</a></li>
									</ul>
								</li>
							</ul>
						</div>
							...
							<div class="header-action-2">
								<div class="header-action-icon-2">
									<a href="shop-wishlist.php">
										<img class="svgInject" alt="Surfside Media" src="{{asset('img/theme/icons/icon-heart.svg')}}">
										<span class="pro-count blue">4</span>
									</a>
								</div>
								<div class="header-action-icon-2">
									<a class="mini-cart-icon" href="cart.html">
										<img alt="Surfside Media" src="{{asset('img/theme/icons/icon-cart.svg')}}">
										...
										<ul>
											<li>
												<div class="shopping-cart-img">
													<a href="product-details.html"><img alt="Surfside Media" src="{{asset('img/shop/thumbnail-3.jpg')}}"></a>
												</div>
											...
											<li>
												<div class="shopping-cart-img">
													<a href="product-details.html"><img alt="Surfside Media" src="{{asset('img/shop/thumbnail-2.jpg')}}"></a>
												</div>
												<div class="shopping-cart-title">
				...
				<div class="header-wrap header-space-between position-relative">
											...
											<ul class="mega-menu d-lg-flex">
												...
												<li class="mega-menu-col col-lg-5">
													<div class="header-banner2">
														<img src="{{asset('img/banner/menu-banner-2.jpg')}}" alt="menu_banner1">
													...
													<div class="header-banner2">
														<img src="{{asset('img/banner/menu-banner-3.jpg')}}" alt="menu_banner2">
														<div class="banne_info">
															<h6>15% Off</h6>
															<h4>Hot Deals</h4>
															<a href="#">Shop now</a>
									...
									<li class="has-children">
										...
										<div class="dropdown-menu">
											<ul class="mega-menu d-lg-flex">
												...
												<li class="mega-menu-col col-lg-5">
													<div class="header-banner2">
														<img src="{{asset('img/banner/menu-banner-4.jpg')}}'" alt="menu_banner1">
														<div class="banne_info">
															<h6>10% Off</h6>
															<h4>New Arrival</h4>
															<a href="#">Shop now</a>
									...
									<li class="has-children">
										...
										<div class="dropdown-menu">
											<ul class="mega-menu d-lg-flex">
												...
												<li class="mega-menu-col col-lg-5">
													<div class="header-banner2">
														<img src="{{asset('img/banner/menu-banner-5.jpg')}}" alt="menu_banner1">
														<div class="banne_info">
															<h6>10% Off</h6>
															<h4>New Arrival</h4>
															<a href="#">Shop now</a>
													...
													<div class="header-banner2">
														<img src="{{asset('img/banner/menu-banner-6.jpg')}}" alt="menu_banner2">
														<div class="banne_info">
															<h6>15% Off</h6>
															<h4>Hot Deals</h4>
															<a href="#">Shop now</a>
										...
										<ul class="mega-menu">
											...
											<li class="sub-mega-menu sub-mega-menu-width-34">
												<div class="menu-banner-wrap">
													<a href="product-details.html"><img src="{{asset('img/banner/menu-banner.jpg')}}" alt="Surfside Media"></a>
					...
					<div class="header-action-right d-block d-lg-none">
						<div class="header-action-2">
							<div class="header-action-icon-2">
								<a href="shop-wishlist.php">
									<img alt="Surfside Media" src="{{asset('img/theme/icons/icon-heart.svg')}}">
							...
							<div class="header-action-icon-2">
								...
								<div class="cart-dropdown-wrap cart-dropdown-hm2">
									<ul>
										...
										<li>
											<div class="shopping-cart-img">
												<a href="product-details.html"><img alt="Surfside Media" src="{{asset('img/shop/thumbnail-4.jpg')}}"></a>
											</div>
											<div class="shopping-cart-title">
		...
		<div class="mobile-header-wrapper-inner">
			...
			<div class="mobile-header-content-area">
				...
				<div class="mobile-social-icon">
					...
					<a href="#"><img src="{{asset('img/theme/icons/icon-facebook.svg')}}" alt=""></a>
					<a href="#"><img src="{{asset('img/theme/icons/icon-twitter.svg')}}" alt=""></a>
					<a href="#"><img src="{{asset('img/theme/icons/icon-instagram.svg')}}" alt=""></a>
					<a href="#"><img src="{{asset('img/theme/icons/icon-pinterest.svg')}}" alt=""></a>
					<a href="#"><img src="{{asset('img/theme/icons/icon-youtube.svg')}}" alt=""></a>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="col-lg-7 mb-md-3 mb-lg-0">
						<div class="row align-items-center">
							<div class="col flex-horizontal-center">
								<img class="icon-email" src="{{asset('img/theme/icons/icon-email.svg')}}" alt="">
						...
						<div class="row">
							<div class="col-md-8 col-lg-12">
								...
								<div class="download-app wow fadeIn animated mob-app">
									<a href="#" class="hover-up mb-sm-4 mb-lg-0"><img class="active" src="{{asset('img/theme/app-store.jpg')}}" alt=""></a>
									<a href="#" class="hover-up"><img src="{{asset('img/theme/google-play.jpg')}}" alt=""></a>
								</div>
							</div>
