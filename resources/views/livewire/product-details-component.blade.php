                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            <div><img src="{{ asset('img/shop/thumbnail-3.jpg')}}" alt="product image"></div>
                                            <div><img src="{{ asset('img/shop/thumbnail-4.jpg')}}" alt="product image"></div>
                                            <div><img src="{{ asset('img/shop/thumbnail-5.jpg')}}" alt="product image"></div>
                                            <div><img src="{{ asset('img/shop/thumbnail-6.jpg')}}" alt="product image"></div>
                                            <div><img src="{{ asset('img/shop/thumbnail-7.jpg')}}" alt="product image"></div>
                                            <div><img src="{{ asset('img/shop/thumbnail-8.jpg')}}" alt="product image"></div>
                                            <div><img src="{{ asset('img/shop/thumbnail-9.jpg')}}" alt="product image"></div>
                                        </div>
                                    </div>
                                    <!-- End Gallery -->
                                    <div class="social-icons single-share">
                                        <ul class="text-grey-5 d-inline-block">
                                            ...
                                            <li class="social-facebook"><a href="#"><img src="{{ asset('img/theme/icons/icon-facebook.svg')}}" alt=""></a></li>
                                            <li class="social-twitter"> <a href="#"><img src="{{ asset('img/theme/icons/icon-twitter.svg')}}" alt=""></a></li>
                                            <li class="social-instagram"><a href="#"><img src="{{ asset('img/theme/icons/icon-instagram.svg')}}" alt=""></a></li>
                                            <li class="social-linkedin"><a href="#"><img src="{{ asset('img/theme/icons/icon-pinterest.svg')}}" alt=""></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="comment-list">
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{ asset('img/page/avatar-6.jpg')}}" alt="">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{ asset('img/page/avatar-7.jpg')}}" alt="">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{ asset('img/page/avatar-8.jpg')}}" alt="">
