...
class HomeComponent extends Component
{
       public function store($product_id, $product_name, $product_price): void
    {
        ...
        Cart::instance('cart')->add($product_id, $product_name, 1, $product_price, ['slug' => $cartItem->slug, 'image'=>$cartItem->image])->associate
        ('Product');
    ...
    public function render()
    {
        ...
        return view('livewire.home-component', compact('slides', 'new_arrivals','featured_products'));
    }
}
